...
{
  "$end", "error", "$undefined", "REQUEST", "PARAMREQUEST", "CMD",
  "PARAMCMD", "DOISPONTOS", "COMENTARIO", "NL", "$accept", "linhas",
  "linha", "requestLine", "comando", "parametros", "cmdLine", YY_NULLPTR
};
#endif
...
{
      11,    15,    10,     1,    16,     2,    13,    14,     3,     4,
       1,    15,     2,    18,    19,     3,     4,    12,     0,     0,
       0,    20
};
...
{
       0,     3,     5,     8,     9,    11,    12,    13,    14,    16,
       4,     0,    12,     7,     4,     6,     9,    15,     9,     9,
      15
};
...
#line 27 "parser.y" /* yacc.c:1646  */
    {add_command_list((yyvsp[-3].text)); add_param_list_begin((yyvsp[-1].longText)); add_param_list_begin((yyvsp[-2].longText));}
#line 1235 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 28 "parser.y" /* yacc.c:1646  */
    {add_command_list((yyvsp[0].text));}
#line 1241 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 29 "parser.y" /* yacc.c:1646  */
    {add_param_list_begin((yyvsp[-1].longText));}
